...
def main():
    ...
    parser.add_argument("-c","--connection", default='mongodb://mongo1:27017,mongo2:27018,mongo3:27019/?replicaSet=rs0', help="MongoDB connection string")
...
#add average to root document, each doc rep a stock symbol for a day
#archival is to remote array
